...
const AddUserPage = () => {
    ...
    const validateForm = () => {
        ...
        if (isNaN(formData.waste) || parseFloat(formData.waste) < 0) {
            errors.waste = "Jumlah sampah tidak valid";
        }
    ...
    const handleSubmit = (e) => {
        ...
        const newUser = {
            ...
            totalWaste: parseFloat(formData.waste) || 0,
        ...
        setTimeout(() => {
            ...
            addActivity({
                type: "add_user",
                user: newUser.name,
                action: `Warga "${formData.name}" (Email: ${formData.email}) telah ditambahkan.`,
    ...
    const handleWasteChange = useCallback((e) => {
                                ...
                                <div className="flex items-start justify-between">
                                    ...
                                    >
                                        ...
                                        <p className="text-slate-600 text-lg">
                                            Daftarkan warga baru ke dalam sistem manajemen bank sampah
                                        </p>
                                    </motion.div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <motion.div className="space-y-2" variants={itemVariants}>
                                                ...
                                                >
                                                    <motion.div
                                                        ...
                                                        animate={{
                                                            color:
                                                                focusedField === "name" ? "#3b82f6" : "#94a3b8",
                                                        }}
                                                        transition={{ duration: 0.2 }}
                                                    >
                                            ...
                                            <motion.div className="space-y-2" variants={itemVariants}>
                                                <div className="flex items-center justify-between">
                                                    <label htmlFor="waste" className="block text-sm font-semibold text-slate-800">
                                                        Jumlah Sampah
                                                        <span className="text-red-500 ml-1 text-xs">*</span>
                                                    </label>
                                                ...
                                                <motion.div className="relative group" whileHover={{ scale: 1.01 }}>
                                                    <motion.div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none"
                                                        animate={{ color: focusedField === "waste" ? "#3b82f6" : "#94a3b8" }}>
                                                    ...
                                                    <motion.input
                                                        ...
                                                        onFocus={() => handleFocus("waste")}
                                                        onBlur={() => handleBlur("waste")}
                                                        placeholder="0"
                                                        className={`block w-full px-4 py-3 pl-10 bg-white border-2 rounded-xl shadow-sm transition-all duration-300
                                                        ${validationErrors.waste && touchedFields.waste
                                                ...
                                                {validationErrors.waste && touchedFields.waste && (
                                                    <motion.div className="flex items-center space-x-2 text-red-600 text-sm bg-red-50 px-3 py-2 rounded-lg">
                                                        <i className="fas fa-exclamation-triangle text-xs"></i>
                                                        <span>{validationErrors.waste}</span>
                                                    </motion.div>
                                                )}
                                            </motion.div>
                                        </motion.div>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                <p className="text-slate-500 text-sm">
                                                    Informasi lokasi dan status warga
                                                </p>
                                            </div>
                                        </motion.div>
                                        ...
                                        >
                                            ...
                                            <motion.div className="space-y-2" variants={itemVariants}>
                                                ...
                                                >
                                                    ...
                                                    <span>
                                                        Status dapat diubah sewaktu-waktu melalui halaman
                                                        edit
                                                    </span>
                                                </motion.div>
                                            </motion.div>
                                        ...
                                        <AnimatePresence>
                                            {formProgress < 100 && (
                                                ...
                                                >
                                                    ...
                                                    />
                                                    <span>
                                                        Lengkapi semua field yang wajib diisi untuk
                                                        melanjutkan
                                                    </span>
                                                </motion.div>
                                            )}
